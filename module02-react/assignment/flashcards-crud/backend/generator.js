...
/*
    pass the data into a const variable
    use a .map() to read the data, create an id for each item and also sort it
    then, pass the variable as argument into the function generateFile to generate a new json file
*/
...
async function generateFile() {
    fs.writeFile(
        './flashcards.json',
        JSON.stringify({ flashcards: data }, null, 2)
    );
}
